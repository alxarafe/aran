    ...
    if ($action == 'update' && ($caneditfield || !empty($user->admin))) {
        if (!$_POST["cancel"]) {
            ...
            if ($val == '') {
                ...
                $tabparam['THEME_ELDY_TOPMENU_BACK1'] = join(',', colorStringToArray(GETPOST('THEME_ELDY_TOPMENU_BACK1'), array()));
            }
            ...
            if ($val == '') {
                ...
                $tabparam['THEME_ELDY_BACKTITLE1'] = join(',', colorStringToArray(GETPOST('THEME_ELDY_BACKTITLE1'), array()));
            }
