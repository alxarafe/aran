...
Debug::addMessage('Deprecated', 'TODO: Using security.lib.php file');
...
function accessforbidden($message = '', $printheader = 1, $printfooter = 1, $showonlymessage = 0)
{
    ...
    if (!$message) {
        print Globals::$langs->trans("ErrorForbidden");
    } else {
        print $message;
    }
    print '</div>';
    ...
    if (empty($showonlymessage)) {
        if (Globals::$user->login) {
            print Globals::$langs->trans("CurrentLogin") . ': <font class="error">' . Globals::$user->login . '</font><br>';
            print Globals::$langs->trans("ErrorForbidden2", Globals::$langs->trans("Home"), Globals::$langs->trans("Users"));
        } else {
            print Globals::$langs->trans("ErrorForbidden3");
        }
    }
