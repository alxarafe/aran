 ...
 * Copyright (C) 2019       Alxarafe            <info@alxarafe.es>
 *
...
class PaymentSalary extends CommonObject
{
            ...
            if ($this->id > 0) {
                if (!empty($conf->banque->enabled) && !empty($this->amount)) {
                    ...
                    $bank_line_id = $acc->addline(
                        $this->datep, $this->type_payment, $this->label, -abs($this->amount), $this->num_payment, '', $user, '', '', '', $this->datev
                    );
                    ...
                    $result = $acc->add_url_line(
                        //$bank_line_id, $this->fk_user, DOL_URL_ROOT . '/user/card.php?id=', $fuser->getFullName($langs),
                        $bank_line_id, $this->fk_user, BASE_URI . '?controller=user&method=card&id=', $fuser->getFullName($langs),
    ...
    function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = DOL_BASE_URI . '?controller=compta/salaries&method=card&id=' . $this->id;
