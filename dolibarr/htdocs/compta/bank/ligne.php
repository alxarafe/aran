...
if ($user->rights->banque->modifier && $action == "update") {
    ...
    if (!$error) {
        ...
        if (isset($_POST['value'])) {
            $sql .= " fk_type='" . $db->escape($_POST['value']) . "',";
        }
        if (isset($_POST['num_chq'])) {
            $sql .= " num_chq='" . $db->escape($_POST["num_chq"]) . "',";
        }
        if (isset($_POST['banque'])) {
            $sql .= " banque='" . $db->escape($_POST["banque"]) . "',";
        }
        if (isset($_POST['emetteur'])) {
            $sql .= " emetteur='" . $db->escape($_POST["emetteur"]) . "',";
        }
        // Blocked when conciliated
        if (!$acline->rappro) {
            if (isset($_POST['label'])) {
                $sql .= " label='" . $db->escape($_POST["label"]) . "',";
            }
            if (isset($_POST['amount'])) {
                $sql .= " amount='" . $amount . "',";
            }
            if (isset($_POST['dateomonth'])) {
                $sql .= " dateo = '" . $db->idate($dateop) . "',";
            }
            if (isset($_POST['datevmonth'])) {
        ...
        if (count($links)) {
            ...
            foreach ($links as $key => $val) {
                ...
                if ($links[$key]['type'] == 'payment') {
                    ...
                    print '<a href="' . BASE_URI . '?controller=compta/paiement&method=card&id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowPayment'), 'payment') . ' ';
                    print $langs->trans("Payment");
                    print '</a>';
                } else if ($links[$key]['type'] == 'payment_supplier') {
                    // print '<a href="' . DOL_URL_ROOT . '/fourn/paiement/card.php?id=' . $links[$key]['url_id'] . '">';
                    print '<a href="' . BASE_URI . '?controller=fourn/paiement&method=card&id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowPayment'), 'payment') . ' ';
                    print $langs->trans("Payment");
                    print '</a>';
                    ...
                    print '<a href="' . BASE_URI . '?controller=compta/sociales&method=card&id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=compta/payment_sc&method=card&id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowPayment'), 'payment') . ' ';
                    print $langs->trans("SocialContributionPayment");
                    print '</a>';
                } else if ($links[$key]['type'] == 'payment_vat') {
                    // print '<a href="' . DOL_URL_ROOT . '/compta/tva/card.php?id=' . $links[$key]['url_id'] . '">';
                    print '<a href="' . BASE_URI . '?controller=compta/tva&method=card&id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=compta/salaries&method=card&id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=loan/payment&method=card&id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=loan&method=card&id=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowLoan'), 'bill') . ' ';
                    print $langs->trans("Loan");
                    print '</a>';
                } else if ($links[$key]['type'] == 'member') {
                    // print '<a href="' . DOL_URL_ROOT . '/adherents/card.php?rowid=' . $links[$key]['url_id'] . '">';
                    print '<a href="' . BASE_URI . '?controller=adherents&method=card&rowid=' . $links[$key]['url_id'] . '">';
                    print img_object($langs->trans('ShowMember'), 'user') . ' ';
                    print $links[$key]['label'];
                    print '</a>';
                } else if ($links[$key]['type'] == 'payment_donation') {
                    // print '<a href="' . DOL_URL_ROOT . '/don/payment/card.php?id=' . $links[$key]['url_id'] . '">';
                    print '<a href="' . BASE_URI . '?controller=don/payment&method=card&id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=compta/bank&method=ligne&rowid=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=user&method=card&id=' . $links[$key]['url_id'] . '">';
                    ...
                    print '<a href="' . BASE_URI . '?controller=compta/bank/various_payment&method=card&id=' . $links[$key]['url_id'] . '">';
