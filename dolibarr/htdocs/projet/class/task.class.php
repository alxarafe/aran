    ...
    function load_board($user)
    {
        ...
        if ($resql) {
            ...
            if ($user->rights->projet->all->lire) {
                ...
                $response->url = BASE_URI . '?controller=projet/tasks&method=list&mainmenu=project';
            } else {
                // $response->url = DOL_URL_ROOT . '/projet/tasks/list.php?mode=mine&amp;mainmenu=project';
                $response->url = BASE_URI . '?controller=projet/tasks&method=list&mode=mine&amp;mainmenu=project';
