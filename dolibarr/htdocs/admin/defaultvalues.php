...
if ($mode == 'createform') {
    $texthelp .= $langs->trans("PageUrlForDefaultValuesCreate", '?controller=societe&method=card', '?controller=societe&method=card&abc=val1&def=val2');
} else {
    $texthelp .= $langs->trans("PageUrlForDefaultValuesList", '?controller=societe&method=list', '?controller=societe&method=list&abc=val1&def=val2');
}
