...
$type = Request::getAlphaNoHtml('search_type') ?? Request::getAlphaNoHtml('type');
$optioncss = Request::getAlpha('optioncss');
$year = Request::getNumber("year");
$month = Request::getNumber("month");
$day = Request::getNumber("day");
