...
$bid = Request::getNumber('bid');

// Securite acces client
$socid = Request::getNumber('socid');
...
if (!empty($conf->societe->enabled) && $user->rights->societe->lire) {
    ...
    if ($resql) {
        ...
        if (empty($conf->global->SOCIETE_DISABLE_PROSPECTS) && empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) {
            print $langs->trans("BoxTitleLastCustomersOrProspects", $max);
        } else if (!empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) {
            print $langs->trans("BoxTitleLastModifiedProspects", $max);
        } else {
