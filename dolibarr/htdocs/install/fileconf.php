    ...
    <table class="nobordernopadding<?php if ($force_install_noedit) print ' hidewhennoedit'; ?>">
        ...
        <tr>
            ...
            if (empty($dolibarr_main_url_root)) {
                ...
                $dolibarr_main_document_root = DOL_BASE_PATH;
            }
        ...
        <tr>
            ...
            if (empty($dolibarr_main_data_root)) {
                ...
                $dolibarr_main_data_root = BASE_PATH . 'dolibarr/documents';
            }
        ...
        if (empty($dolibarr_main_url_root)) {
            ...
            $dolibarr_main_url_root = BASE_URI;
        }
...
// Do not autofill password if instance is a production instance
                       if (!empty($_SERVER["SERVER_NAME"]) && !in_array($_SERVER["SERVER_NAME"], array('127.0.0.1', 'localhost', 'localhostgit'))
                       ) {
                           $autofill = '';
